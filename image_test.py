...
img = cv2.imread('./1013/00.bmp')
# img = cv2.imread('./1013/01.bmp')
# img = cv2.imread('./1013/10.bmp')
# img = cv2.imread('./1013/11.bmp')
# img = cv2.imread('./1013/tunnel.bmp')
# img = cv2.imread('./1013/nightmode.bmp')
...
# img = img[38:140, 25:490]
# cv2.imshow('image', img)
# cv2.waitKey()

while True :
    roi_1 = img[38:140, 25:490]
