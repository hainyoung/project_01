...
sys.path.append("C:\\Users\\Fazliddin\\Desktop\\step_4_video_solution\\functions_daejon.py") 

# Importing the functions 
from functions_daejon import *
...
# cap = cv2.VideoCapture("./1023_output_video.mp4")
...
while(cap.isOpened()):
    ...
    if c%1==0:
        ...
        # x_2,y_2,h_2,w_2 = 1004,505,77,136 #inyoung
        x_2,y_2,h_2,w_2 = 1010,511,74,134 # me
        rec_2 = draw_rec(frame,"Speed", x_2,y_2,h_2,w_2) 

        roi_speed = speed_digit_recognizer(frame,1010,511,74,134)
        # roi_speed = speed_digit_recognizer(frame,1014,515,86,58) # daejeon video
