...
#     # date_gray = date_gray.astype('uint8')
#     # print(date_gray.shape)
#     # print(date_gray.dtype)
...
#     blur_date = cv2.medianBlur(date_bin, 3)
...
#     cv2.moveWindow('time', 0, 300)
#     cv2.moveWindow('speed', 0, 500)
#     cv2.moveWindow('lane', 0, 700)
#     cv2.moveWindow('auto', 0, 800)
